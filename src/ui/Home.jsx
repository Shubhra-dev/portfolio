...
function Home() {
  return (
    <>
      <Hero />
      <div className="w-5/6 m-auto py-6">
        ...
        <p className="text-lg font-medium py-6 text-center">
          Greetings, I am Shubhradev Chakrabarty, a committed front-end
          developer with a fervent dedication to crafting exceptional web
          applications. My primary expertise lies in
          <span className=" text-sub"> ReactJs </span>
          and <span className=" text-sub">Tailwind CSS</span>, enabling me to
          deliver impeccable user interfaces that harmoniously balance
